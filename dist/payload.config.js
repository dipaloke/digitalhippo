...
exports.default = (0, config_1.buildConfig)({
    ...
    collections: [Users_1.Users, Products_1.Products, Media_1.Media, ProductFile_1.ProductFiles, Orders_1.Orders], //collections:[] later will be our orders, products, users etc.
    routes: {
    ...
    editor: (0, richtext_slate_1.slateEditor)({}), //text editor
