                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, payload.create({
                                ...
                                data: {
                                    ...
                                    products: filteredProducts.map(function (prod) { return prod.id; }), //only need the ids not entire product
                                    user: user.id,
                                },
                            })];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                                success_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=").concat(order.id), //where people will be redirected after payment process.
                                cancel_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/cart"), //redirect to cart if user cancels
