...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        cursor: zod_1.z.number().nullish(), //cursor is the last element rendered. While user is scrolling cursor will fetch the next page of products for infinite query.
        query: query_validator_1.QueryValidator, //custom validator
    }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, queryOpts, payload, parsesQueryOpts, page, _b, items, hasNextPage, nextPage;
