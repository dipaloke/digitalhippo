    ...
    fields: [
        {
            ...
            admin: {
                condition: function () { return false; }, //hides this options from admin dashboard(users don't need to see this field)
            },
        },
        {
            name: "name",
        ...
        },
        {
            ...
            label: "Category",
            type: "select",
            options: config_1.PRODUCT_CATAGORIES.map(function (_a) {
        ...
        //correspond to stripe priceId for payment
        {
            name: "priceId",
            access: {
                create: function () { return false; }, //no one should have permission to edit price
                read: function () { return false; }, //could only be overwritten in backend code
