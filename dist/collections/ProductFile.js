...
var addUser = function (_a) {
    ...
    var user = req.user;
    return __assign(__assign({}, data), { user: user === null || user === void 0 ? void 0 : user.id }); //spreading data then adding userId with data
};
...
exports.ProductFiles = {
    ...
    access: {
        ...
        delete: function (_a) {
            var req = _a.req;
            return req.user.role === "admin";
        }, //so users cant delete their products.
    },
