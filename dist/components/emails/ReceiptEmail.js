                ...
                products.map(function (product) {
                    ...
                    return (react_1.default.createElement(components_1.Section, { key: product.id },
                        ...
                        react_1.default.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            product.description ? (react_1.default.createElement(components_1.Text, { style: productDescription }, Array.isArray(product.description) &&
                                product.description.length > 0
                                ? // Check if the first item has a 'description' property
                                    typeof product.description[0].description === "string"
                                        ? product.description[0].description.length > 50
                                            ? product.description[0].description.slice(0, 50) +
                                                "..."
                                            : product.description[0].description
                                        : product.name //show product name if description not available
